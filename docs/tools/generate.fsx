...
let githubLink = "https://github.com/theor/GitShow"

// Specify more information about your project
let info =
  [ "project-name", "GitShow"
    "project-author", "theor"
    "project-summary", "Code presentations with git"
    "project-github", githubLink
    "project-nuget", "http://nuget.org/packages/GitShow" ]
